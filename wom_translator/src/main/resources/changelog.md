...
Date: 2026-09-10
Changes:
	- Renamed plugin from "Manhwa Translator AI" to "WOM Translator".
Fixed:
  - Fixed `NoClassDefFoundError: ai/koog/http/client/ktor/KtorKoogHttpClientKt` by preserving `ai.koog` Ktor client adapter in the plugin JAR packaging.
-------------------------------------------------------------------------------------------------
Version: 1.4.2
Date: 2026-09-05
Added:
