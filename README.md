...
| **PSD Builder Native** | `com.wip.psdbuilder.native` | — | `5.3.0` | Native PSD generation from images, typography, and OCR data using KPsd (pure library, zero ONNX runtime bundled). |
