...
class BetterIMG {
    ...
    fun imageProcessor(
        ...
        folder: String,
            @CapabilityParam(description = "Image type: Manga or Manwha", defaultValue = "Manwha")
            imageType: ImageType = ImageType.Manwha,
            @CapabilityParam(description = "Output width in pixels", defaultValue = "1000")
            width: Int = 1000,
            @CapabilityParam(description = "Grain level for processing", defaultValue = "1")
            grain: Int = 1,
            ...
            @CapabilityOutput(
                    ...
                    autogeneratedPattern = "{folder}/out/"
            )
        outFolder: String,
    ...
    private fun runImageProcessor(
        ...
        logger.info("Type: $imageType, Width: $width, Grain: $grain, Format: $outputFormat")
