...
class Slicer {
    ...
    fun slicer(
        ...
        val resolvedOutputDir = java.io.File(folderPath, "output").absolutePath
        val outputDir = Path(resolvedOutputDir)
        ...
        logger.log("Slicing completed. Error: $displayError. Output directory: $resolvedOutputDir")
