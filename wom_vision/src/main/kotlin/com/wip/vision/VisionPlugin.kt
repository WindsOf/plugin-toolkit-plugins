...
class VisionPlugin(val settings: VisionSettings = VisionSettings()) {
    ...
    suspend fun detectAndSegment(
        @CapabilityInput(
            description = "Path to input image (JPG, PNG, WebP)",
            semanticTypes = ["file/jpg", "file/png", "file/webp"]
        )
        imagePath: String,
        @CapabilityOutput(
        ...
        @CapabilityParam(
            description = "Detection sliding window overlap ratio (0.0 to 0.8)",
            defaultValue = "0.25",
            isAdvanced = true
        )
        ...
        @CapabilityParam(
            description = "Segmentation sliding window overlap ratio (0.0 to 0.8)",
            defaultValue = "0.25",
            isAdvanced = true
        )
        segmentOverlap: Double = 0.25,
        @CapabilityParam(
            description = "Save binary mask image for detected text",
            defaultValue = "false"
        )
    ...
    suspend fun detectAndSegmentChapter(
        ...
        segmentOverlap: Double = 0.25,
        @CapabilityParam(
            description = "Save visual debug images showing all detected/segmented bounding boxes and contours",
            defaultValue = "false"
        )
